    ...
    with Total Solutions
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <motion.div variants={buttonVariants} initial="hidden" animate="visible">
            <Button variant="primary" size="medium" className="rounded-2xl shadow-lg px-10 py-5 bg-brown text-white text-lg font-medium">
              Shop Bundles
            </Button>
          </motion.div>
...
<Link href="/account">
  <Button
    variant="secondary"
    size="large"
    className="rounded-2xl px-10 py-5 bg-gray border-2 border-black-900 text-black-900 text-lg font-medium"
  >
    Build Bundle
  </Button>
</Link>
